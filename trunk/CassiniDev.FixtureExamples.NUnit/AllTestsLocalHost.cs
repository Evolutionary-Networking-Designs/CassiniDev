...
namespace CassiniDev.FixtureExamples.NUnit
{
    ...
    /// </summary>
    [TestFixture]
    public class AllTestsLocalHost : Fixture
    {
        ...
        public void TestFixtureSetUp()
        {
            ...
            StartServer(@"..\..\..\CassiniDev.FixtureExamples.TestWeb", IPAddress.Loopback, GetPort(8080, 9000, IPAddress.Loopback), "/", null, false, 10000, 15000);
        }
