...
<xsl:output method="xml" version="1.0" encoding="UTF-8" doctype-public="-//W3C//DTD XHTML 1.1//EN" doctype-system="http://www.w3.org/TR/xhtml11/DTD/xhtml11.dtd" indent="yes"/>
	...
	<xsl:template match="/crap_result">
   		<html>
			<head>
				<title>CRAP Report Detail (Sorted by Coverage) for <xsl:value-of select="project"/></title>
				<style type="text/css">
			...
			<body>
				<h2>CRAP Report Detail</h2><h4>(Sorted by Coverage)</h4><h3 style="text-align: center;">Project: <xsl:value-of select="project"/></h3>
				<center><a href="index.html">Overview Page</a> | 
				<a href="detail_crap_load.html">CRAP Load</a> |
				<a href="detail_crap.html">CRAP</a> |
				<a href="detail_complexity.html">Complexity</a></center>
	...
	<xsl:template match="methods">
		<table border="1">
			...
			<xsl:for-each select="method">
				<xsl:sort data-type="number" order="ascending" select="coverage"/>
