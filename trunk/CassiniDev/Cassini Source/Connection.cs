    ...
    public class Connection : MarshalByRefObject
    {
        ...
        internal static string GetContentType(string fileName)
        {
            ...
            switch (extension)
            {
                ...
                case ".ad": contentType = "text/plain"; break;
                ...
                case ".adts": contentType = "audio/vnd.dlna.adts"; break;
                ...
                case ".c2r": contentType = "text/vnd-ms.click2record+xml"; break;
                ...
                case ".dd": contentType = "text/plain"; break;
                case ".def": contentType = "text/plain"; break;
                
                case ".design": contentType = "image/design"; break;
                ...
                case ".easmx": contentType = "model/vnd.easmx+xps"; break;
                case ".edrwx": contentType = "model/vnd.edrwx+xps"; break;
                case ".eprtx": contentType = "model/vnd.eprtx+xps"; break;
                case ".fdf": contentType = "application/vnd.fdf"; break;
                case ".filters": contentType = "Application/xml"; break;
                case ".flc": contentType = "video/flc"; break;
                ...
                case ".nix": contentType = "application/x-mix-transfer"; break;
                ...
                case ".pxr": contentType = "image/pxr"; break;
                case ".qcp": contentType = "audio/vnd.qcelp"; break;
                ...
                case ".raw": contentType = "application/octet-stream"; break;
                ...
                case ".rels": contentType = "application/vnd.ms-package.relationships+xml"; break;
                ...
                case ".rms": contentType = "application/vnd.rn-realaudio-secure"; break;
                ...
                case ".rtsp": contentType = "application/x-rtsp"; break;
                ...
                case ".sgi": contentType = "image/x-sgi"; break;
                ...
                case ".tga": contentType = "image/x-targa"; break;
                case ".targa": contentType = "image/x-targa"; break;
                ...
                case ".xbrl": contentType = "text/xml"; break;
                case ".xdp": contentType = "application/vnd.adobe.xdp+xml"; break;
                case ".xdr": contentType = "application/xml"; break;
                case ".xej": contentType = "application/xej+xml"; break;
                case ".xel": contentType = "application/xel+xml"; break;
                case ".xesc": contentType = "application/x-ms-wmv"; break;
                case ".xfd": contentType = "application/vnd.adobe.xfd+xml"; break;
                ...
                case ".xpr": contentType = "image/xpr"; break;
                ...
                case ".msg": contentType = "application/vnd.ms-outlook"; break;
                ...
                case ".p7c": contentType = "application/x-pkcs7-mime"; break;
                case ".p7m": contentType = "application/x-pkcs7-mime"; break;
                case ".p7r": contentType = "application/x-pkcs7-certreqresp"; break;
                case ".p7s": contentType = "application/x-pkcs7-signature"; break;
                ...
                case ".pko": contentType = "application/ynd.ms-pkipko"; break;
                ...
                case ".sst": contentType = "application/vnd.ms-pkicertstore"; break;
                case ".stl": contentType = "application/vnd.ms-pkistl"; break;
                ...
                case ".vrml": contentType = "x-world/x-vrml"; break;
